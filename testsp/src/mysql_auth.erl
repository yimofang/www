...
%% TODO // Added by vinoth on 18-03-2014 for mysql stored procedures support
...
make_new_auth(User, Password, Database) ->
    ...
    %% TODO // modified by vinoth on 18-03-2014 for mysql stored procedures support
    %%Caps = ?LONG_PASSWORD bor ?LONG_FLAG bor ?TRANSACTIONS bor
	%%?PROTOCOL_41 bor ?SECURE_CONNECTION bor DBCaps
	%%bor ?FOUND_ROWS,
	Caps = ?LONG_PASSWORD bor ?LONG_FLAG bor ?TRANSACTIONS bor
	?PROTOCOL_41 bor ?SECURE_CONNECTION  bor ?CLIENT_MULTI_STATEMENTS bor ?CLIENT_MULTI_RESULTS bor DBCaps
	bor ?FOUND_ROWS,
