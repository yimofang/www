%% @author hyf
%% @doc @todo Add description to ' emipian_hooks'.


-module(emipian_hooks).
...
%%%----------------------------------------------------------------------
start_link() ->
    gen_server:start_link({local, emipian_hooks}, emipian_hooks, [], []).
...
add(Hook, Host, Module, Function, Seq) ->
    gen_server:call(emipian_hooks, {add, Hook, Host, Module, Function, Seq}).
  
-spec add_dist(atom(), atom(), atom(), atom() | fun(), number()) -> any().

add_dist(Hook, Node, Module, Function, Seq) ->
    gen_server:call(emipian_hooks, {add, Hook, global, Node, Module, Function, Seq}).

-spec add_dist(atom(), binary() | global, atom(), atom(), atom() | fun(), number()) -> any().

add_dist(Hook, Host, Node, Module, Function, Seq) ->
    gen_server:call(emipian_hooks, {add, Hook, Host, Node, Module, Function, Seq}).
...
delete(Hook, Host, Module, Function, Seq) ->
    gen_server:call(emipian_hooks, {delete, Hook, Host, Module, Function, Seq}).
...
delete_dist(Hook, Host, Node, Module, Function, Seq) ->
    gen_server:call(emipian_hooks, {delete, Hook, Host, Node, Module, Function, Seq}).
